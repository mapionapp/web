    ...
    <v-content>
      ...
      <v-dialog v-model="initialDialogOpen">
        <v-card class="pa-3" color="red darken-1" dark>
          ...
          <div class="my-3">
            Dies ist eine Webseite, die jeder und jedem in unserer Gesellschaft
            den Zugang zu notwendigen Gütern in dieser schwierigen Zeit
            erleichtern soll. Diese Webseite ist <strong>kein</strong> Ort, um
            Hamsterkäufe zu planen.
          </div>
